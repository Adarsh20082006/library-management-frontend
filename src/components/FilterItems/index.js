    ...
    return (
        <div className="main-container">
            <div className="filter-container">
                <h1 className="filter-title">Filter Books</h1>
                ...
                <div className="year-container">
                    ...
                    <ul className="year-list">
                        {publishedYears.map((eachYear) => (<li key={eachYear.id} className={`year-item ${eachYear.name === publishedYear ? 'active' : ''}`} onClick={() => setPublishedYear(eachYear.name)}>After {eachYear.name}</li>))}
                    </ul>
                </div>
